...
WebUI.click(findTestObject('Page_DataDrivenObjects/span_sub_your_options',['option':option]))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_DataDrivenObjects/h3_about_fine',['option':option]),10)
